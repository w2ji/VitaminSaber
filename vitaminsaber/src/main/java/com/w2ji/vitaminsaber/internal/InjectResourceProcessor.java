...
public class InjectResourceProcessor extends AbstractProcessor{
    ...
    @Override public boolean process(Set<? extends TypeElement> elements, RoundEnvironment env) {
        Map<TypeElement, ResourceInjector> targetClassMap = findAndParseTargets(env);

        for (Map.Entry<TypeElement, ResourceInjector> entry : targetClassMap.entrySet()) {
    ...
    private Map<TypeElement, ResourceInjector> findAndParseTargets(RoundEnvironment env) {
        Map<TypeElement, ResourceInjector> targetClassMap =
    ...
    private ResourceInjector getOrCreateTargetClass(Map<TypeElement, ResourceInjector> targetClassMap,
